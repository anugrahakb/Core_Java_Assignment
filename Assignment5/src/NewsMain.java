...
public class NewsMain {
	...
	public static void main(String[] args) {
		...
		al.add(new News(22,"Nayana","Anju","new budget list is good"));
		al.add(new News(23,"Vikky","Nimish","Finally ipl started"));
		al.add(new News(23,"Vikky","Nikky","I support kkr"));
		al.add(new News(22,"Arjun","Narhsa","wbu 12 exam"));
		al.add(new News(22,"Nayana","Yadhu","without budget list"));
		al.add(new News(22,"Nayana","Yadhu","without budget list"));
